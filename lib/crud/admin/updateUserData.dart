...
class _State extends State<UpdateUserData> {
  ...
  void update() {
    ...
    http.post(
      url,
      body: {
        "id_user": widget.list[widget.index]['id_user'],
  ...
  @override
  void initState() {
    namalengkap = new TextEditingController(
      text: widget.list[widget.index]['nama_lengkap'],
    );
    notelepon = new TextEditingController(
      text: widget.list[widget.index]['no_telepon'],
    );
    username = new TextEditingController(
      text: widget.list[widget.index]['username'],
    );
